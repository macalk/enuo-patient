...
}menuArrowStyle;  //枚举 定义变量 结构体


@protocol ZXDMenuDelegate <NSObject>
//代理
@optional
...
@interface ZXDDownMenu : UIView<UITableViewDataSource,UITableViewDelegate,UIGestureRecognizerDelegate>
...
//缩进的动画时间
@property (nonatomic,assign)CGFloat hideAnmationTime;
//菜单的字体的大小
...
@property (nonatomic,assign)id<ZXDMenuDelegate>delegate;




#pragma mark -- -次性创建所有菜单数据
