...
//    backgroundView.backgroundColor = [UIColor grayColor];
    ...
    // TAB
//    tableView = [[UITableView alloc] initWithFrame:CGRectMake( 20 , 70.0 -  20.0 * selectData.count , frame.size.width, 40 * selectData.count) style:0];
     tableView = [[UITableView alloc] initWithFrame:CGRectMake( 20 , 70.0  , frame.size.width, 25 * selectData.count) style:0];
...
//    tableView.transform =  CGAffineTransformMakeScale(0.5, 0.5);
    ...
    tableView.layer.position = CGPointMake(15, 70);
...
//            tableView.frame = CGRectMake(win.bounds.size.width - 35 , 64, 0, 0);
            tableView.transform = CGAffineTransformMakeScale( 0.0001,0.000001);
