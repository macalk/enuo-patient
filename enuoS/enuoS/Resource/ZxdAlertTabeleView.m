...
@interface ZxdAlertTabeleView () <UITableViewDelegate,UITableViewDataSource>
//背景
...
@implementation ZxdAlertTabeleView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.ill.text= self.dataArray[indexPath.row];
