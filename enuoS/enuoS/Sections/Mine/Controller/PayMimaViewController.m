...
@interface PayMimaViewController ()<UITextFieldDelegate,UIAlertViewDelegate>
...
@implementation PayMimaViewController
...
- (IBAction)handleSureWithBtn:(UIButton*)sender {
    ...
    NSString *strs = @"http://www.enuo120.com/index.php/app/patient/change_pay_pwd";
...
- (void)ceatView{
    //原密码
    [self.olderPassTextField setKeyboardType:UIKeyboardTypeNumberPad];
    ...
    //新密码
    [self.changPassTextField setKeyboardType:UIKeyboardTypeNumberPad];
    ...
    [self.SurePassTextField setKeyboardType:UIKeyboardTypeNumberPad];
